...
<form action='adminlogin.php' method="post" class="form-container">
  ...
  <br>
  <p>Apply as Coordinator <a href="register.php">Click Here</a></p>
  <p>Coordinator Login<a href="login.php">Click Here</a></p>
</form>
...
<?php
  //$db = mysqli_connect('localhost','root','password','olx_schema');
   ...
   if(isset($_POST['submit'])){
     ...
     $query = "SELECT *FROM admin WHERE aemail = '$email_address' AND apassword= '$password'";
